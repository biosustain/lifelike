...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['file_id'],
            ['files.id'],
            name=op.f('fk_file_annotations_version_file_id_files'),
            ondelete='CASCADE',
        ),
        sa.ForeignKeyConstraint(
            ['user_id'],
            ['appuser.id'],
            name=op.f('fk_file_annotations_version_user_id_appuser'),
            ondelete='SET NULL',
        ),
        sa.PrimaryKeyConstraint('id', name=op.f('pk_file_annotations_version')),
        sa.UniqueConstraint(
            'hash_id', name=op.f('uq_file_annotations_version_hash_id')
        ),
    )
    op.create_index(
...
def downgrade():
    ...
    op.drop_index(
        op.f('ix_file_annotations_version_user_id'),
        table_name='file_annotations_version',
    )
    op.drop_index(
        op.f('ix_file_annotations_version_file_id'),
        table_name='file_annotations_version',
