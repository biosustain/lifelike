...
You now have a new Keycloak installation reachable at the [web GUI](https://auth.az.lifelike.bio). Proceed to the next section if you would like to import an existing realm into the new installation.
