...
class FileListView(FilesystemBaseView):
    ...
    def delete(self, targets):
        ...
        def is_publication_***ARANGO_USERNAME***(f: Files):
            return (
        ...
        try:
            ...
            for file in files:
                if not is_publication_***ARANGO_USERNAME***(file):
                    raise e
        ...
        def delete_file(file: Files, recursive: bool = False):
            ...
            if file.calculated_project and file.calculated_project.***ARANGO_USERNAME***_id == file.id:
                raise ValidationError(
        ...
        for file in files:
            if is_publication_***ARANGO_USERNAME***(file):
