...
class ManualAnnotationService:
        ...
        if annotation_type == ManualAnnotationType.INCLUSION.value:
            ...
            if check['node_exist'] and not check['synonym_exist']:
                queries = {
                    ...
                    EntityType.PHENOMENA.value: self.graph.create_***ARANGO_DB_NAME***_global_inclusion(entity_type_query_param)  # noqa
                }
    ...
    def _global_annotation_exists_in_kg(self, values: dict):
        ...
        queries = {
            ...
            EntityType.PHENOMENA.value: self.graph.***ARANGO_DB_NAME***_global_inclusion_exist(entity_type_query_param)  # noqa
        }
