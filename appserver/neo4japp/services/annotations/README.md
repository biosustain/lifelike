...
docker compose -f docker-compose.dev.yml run --name create-lmdb --rm appserver flask create-lmdb
...
docker compose -f docker-compose.dev.yml run --name create-lmdb --rm appserver flask create-lmdb --file-type Food
```
