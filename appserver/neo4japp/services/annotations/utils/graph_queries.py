...
def get_***ARANGO_DB_NAME***_global_inclusions_by_type(entity_type):
    if entity_type not in node_labels:
        return ''
...
def ***ARANGO_DB_NAME***_global_inclusion_exist(entity_type):
    if entity_type not in node_labels:
        return ''
...
def create_***ARANGO_DB_NAME***_global_inclusion(entity_type):
    if entity_type not in node_labels:
        return ''
