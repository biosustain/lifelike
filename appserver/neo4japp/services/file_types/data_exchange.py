...
class ZipDataExchange(DataExchangeProtocol):
        ...
        with ZipFile(buffer) as zip_file:  # only reading
            for info in zip_file.infolist():
                if info.is_dir():
                    ...
                    if metadata_file:
                        import_ref.***ARANGO_USERNAME*** = dirname == ''
    ...
    def _imports_rebuild_hierarhy(
        ...
        for import_ref in import_id_map.values():
            if not import_ref.***ARANGO_USERNAME***:  # Skip parents of import ***ARANGO_USERNAME*** files
                ...
                if parent_import_ref:
                    ...
                    warn(
                        ServerWarning(
                            ...
                            additional_msgs=(
                                'The file will be added to import ***ARANGO_USERNAME***.',
