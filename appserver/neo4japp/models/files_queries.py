...
def join_projects_to_parents_cte(q_hierarchy: Query):
    ...
    the project ID for the initial file row(s), provided the top-most parent (***ARANGO_USERNAME***) of
...
def build_file_hierarchy_query(condition, projects_table, files_table,
    ...
    query = db.session.query(files_table,
        ...
        .join(projects_table, projects_table.***ARANGO_USERNAME***_id == q_hierarchy_project.c.project_id) \
