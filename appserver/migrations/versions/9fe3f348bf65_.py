...
def upgrade():
    ...
    op.create_index(
        op.f("ix_app_user_role_app_role_id"),
        "app_user_role",
        ["app_role_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_app_user_role_appuser_id"),
        "app_user_role",
        ["appuser_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_directory_directory_parent_id"),
        "directory",
        ["directory_parent_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_directory_projects_id"), "directory", ["projects_id"], unique=False
    )
    op.create_index(
        op.f("ix_directory_user_id"), "directory", ["user_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_worksheets_content_id"), "worksheets", ["content_id"], unique=False
    )
...
def downgrade():
    ...
    op.drop_index(
        op.f("ix_projects_collaborator_role_projects_id"),
        table_name="projects_collaborator_role",
    )
    op.drop_index(
        op.f("ix_projects_collaborator_role_appuser_id"),
        table_name="projects_collaborator_role",
