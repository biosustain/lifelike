...
def data_upgrades():
    ...
    for chunk in window_chunk(files_content, 25):
        ...
        for id, raw in chunk:
            try:
                enrichment_annos = json.loads(raw.decode('utf-8'))
    ...
    for chunk in window_chunk(files, 25):
        ...
        for id, content_id, enrichment_annos in chunk:
            ...
            try:
                ...
                # Add the Files update mapping to the list
                files_to_update.append({'id': id, 'enrichment_annotations': enrichment_annos})
