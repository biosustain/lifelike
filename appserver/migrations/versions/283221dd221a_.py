...
Revision ID: 283221dd221a
Revises: ca18fa3cdbb5
Create Date: 2020-06-07 23:35:26.657864
...
def upgrade():
    ...
    op.add_column('files', sa.Column('dir_id', sa.Integer(), nullable=False))
    op.create_foreign_key(op.f('fk_files_dir_id_directory'), 'files', 'directory', ['dir_id'], ['id'])
    op.add_column('project', sa.Column('dir_id', sa.Integer(), nullable=False))
