...
class Base:
    ...
    RMQ_MESSENGER_USERNAME = os.getenv('RMQ_MESSENGER_USERNAME', 'messenger')
    RMQ_MESSENGER_PASSWORD = os.getenv('RMQ_MESSENGER_PASSWORD', 'password')
    ANNOTATOR_QUEUE = os.getenv('ANNOTATOR_QUEUE', 'annotator')
    ELASTIC_INDEXER_QUEUE = os.getenv('ELASTIC_INDEXER_QUEUE', 'elastic_indexer')
