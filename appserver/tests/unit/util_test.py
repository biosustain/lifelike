...
@pytest.mark.parametrize(
    "camel_input, expected_snake_output",
    [
        ("", ""),
        ("A", "a"),
        ("AB", "ab"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {"testData1": "hello", "testData2": "hi"},
            {"test_data1": "hello", "test_data2": "hi"},
        ),  # noqa
        (
            {"superLongCamelCaseName": ["hi"]},
            {"super_long_camel_case_name": ["hi"]},
        ),  # noqa
        ({"nested": [{"test": "hello"}]}, {"nested": [{"test": "hello"}]}),
        (
            {"camelCase": {"camelCase": {"camelCase": "val"}}},
            {"camel_case": {"camel_case": {"camel_case": "val"}}},
        ),  # noqa
    ],
)
...
@pytest.mark.parametrize(
    ...
    [("str", "str"), (MockEnum.PROPERTY1, "PROPERTY1"), (Decimal("1.123"), "1.123")],
)
