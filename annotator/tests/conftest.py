...
from app.services.arangodb import create_arango_client, create_db, get_db
...
def _create_empty_lmdb(path_to_folder: str, db_name: str):
    ...
    env.open_db(db_name.encode('utf-8'), dupsort=True)  ## type
    env.close()


def _create_entity_lmdb(path_to_folder: str, db_name: str, entity_objs=[]):
    map_size = 1099511627776
    env = lmdb.open(path.join(directory, path_to_folder), map_size=map_size, max_dbs=2)
...
@pytest.fixture(scope="function")
def system_db(arango_client: ArangoClient):
    return get_db(
...
@pytest.fixture(scope='function')
def get_annotation_service(arango_client):
    return AnnotationService(arango_client=arango_client)
...
def get_lmdb_service():
    ...
    for db_name, entity in configs:
        _create_empty_lmdb(f'lmdb/{entity}', db_name)
...
@pytest.fixture(scope='function')
def lmdb_setup_test_local_inclusion_affect_gene_organism_matching():
    ...
    for db_name, entity, data in entities:
        _create_entity_lmdb(f'lmdb/{entity}', db_name, data)


@pytest.fixture(scope='function')
def lmdb_setup_test_gene_vs_protein():
...
@pytest.fixture(scope='function')
def lmdb_setup_test_global_excluded_chemical_annotations():
...
@pytest.fixture(scope='function')
def lmdb_setup_test_global_excluded_compound_annotations():
    rat = create_ner_type_species(
        id='10114',
        category=OrganismCategory.EUKARYOTA.value,
        name='rat',
...
@pytest.fixture(scope='function')
def lmdb_setup_test_global_excluded_disease_annotations():
    rat = create_ner_type_species(
        id='10114',
        category=OrganismCategory.EUKARYOTA.value,
        name='rat',
...
@pytest.fixture(scope='function')
def lmdb_setup_test_global_excluded_gene_annotations():
    rat = create_ner_type_species(
        id='10114',
        category=OrganismCategory.EUKARYOTA.value,
        name='rat',
...
@pytest.fixture(scope='function')
def lmdb_setup_test_global_excluded_phenotype_annotations():
    rat = create_ner_type_species(
        id='10114',
        category=OrganismCategory.EUKARYOTA.value,
        name='rat',
...
@pytest.fixture(scope='function')
def lmdb_setup_test_global_excluded_protein_annotations():
    rat = create_ner_type_species(
        id='10114',
        category=OrganismCategory.EUKARYOTA.value,
        name='rat',
...
@pytest.fixture(scope='function')
def lmdb_setup_test_global_excluded_species_annotations():
    rat = create_ner_type_species(
        id='10114',
        category=OrganismCategory.EUKARYOTA.value,
        name='rat',
...
@pytest.fixture(scope='function')
def lmdb_setup_test_global_exclusions_does_not_interfere_with_other_entities():
    rat = create_ner_type_species(
        id='10114',
        category=OrganismCategory.EUKARYOTA.value,
        name='rat',
...
@pytest.fixture(scope='function')
def lmdb_setup_test_global_gene_inclusion_annotation():
    human = create_ner_type_species(
        id='9606',
        category=OrganismCategory.EUKARYOTA.value,
        name='human',
...
@pytest.fixture(scope='function')
def lmdb_setup_test_no_annotation_for_abbreviation():
...
@pytest.fixture(scope='function')
def lmdb_setup_test_global_inclusion_normalized_already_in_lmdb():
...
@pytest.fixture(scope='function')
def lmdb_setup_test_can_find_food_entities():
...
@pytest.fixture(scope='function')
def lmdb_setup_test_can_find_anatomy_entities():
...
@pytest.fixture(scope='function')
def lmdb_setup_test_gene_organism_escherichia_coli_pdf():
    ...
    for db_names, entity, data in entities:
        _create_entity_lmdb(f'lmdb/{entity}', db_names, data)


@pytest.fixture(scope='function')
def lmdb_setup_test_protein_organism_escherichia_coli_pdf():
...
@pytest.fixture(scope='function')
def lmdb_setup_test_human_is_prioritized_if_equal_distance_in_gene_organism_matching():
...
@pytest.fixture(scope='function')
def lmdb_setup_test_gene_id_changes_to_result_from_kg_if_matched_with_organism():
...
@pytest.fixture(scope='function')
def lmdb_setup_test_new_gene_organism_matching_algorithm():
...
@pytest.fixture(scope='function')
def lmdb_setup_test_prioritize_primary_name_that_equals_synonym():
