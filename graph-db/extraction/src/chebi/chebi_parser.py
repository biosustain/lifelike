...
node_attrs = [PROP_ID, PROP_NAME, PROP_DEF, 'formula', 'charge', PROP_INCHI_KEY, PROP_INCHI,
              PROP_SMILES, 'mass', PROP_ALT_ID]
...
relationship_map = {
    ...
    # special mapping, need to extract relationship type
}
