...
REL_NAMES = {
    ...
    'DBLINKS': RelationshipType(REL_DBLINKS, 'to', NODE.DBLINK, PROP_REF_ID),
}
...
class CompoundParser(DataFileParser):
    def __init__(self, biocyc_dbname, tarfile):
        DataFileParser.__init__(self, biocyc_dbname, tarfile, 'compounds.dat', NODE.COMPOUND,ATTR_NAMES, REL_NAMES, DB_LINK_SOURCES)
