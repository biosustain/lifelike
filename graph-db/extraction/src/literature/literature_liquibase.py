...
class LiteratureChangeLog(ChangeLog):
    ...
    def create_indexes(self):
        ...
        queries.append(
            get_create_constraint_query(
                NODE_LITERATURE_ENTITY,
                PROP_ID,
                'constraint_literatureentity_id'
                ) + ';'
            )
        queries.append(
            get_create_constraint_query(
                NODE_LITERATURE_DISEASE,
                PROP_ID,
                'constraint_literaturedisease_id'
                ) + ';'
            )
        queries.append(
            get_create_constraint_query(
                NODE_LITERATURE_CHEMICAL,
                PROP_ID,
                'constraint_literaturechemical_id'
                ) + ';'
            )
        queries.append(
            get_create_constraint_query(
                NODE_LITERATURE_GENE,
                PROP_ID,
                'constraint_literaturegene_id'
                ) + ';'
            )
        queries.append(
            get_create_constraint_query(
