...
class MeshChangeLog(ChangeLog):
    ...
    def create_indexes(self):
        ...
        queries.append(
            get_create_constraint_query(NODE_SYNONYM, PROP_NAME, 'constraint_ecnumber_id') + ';'
            )
    ...
    def load_treenumber_nodes(self):
        ...
        changeset = CustomChangeSet(
            ...
            comment,
            query,
            f'{self.file_prefix}{MESH_TREENUMBER_FILE}'
            )
        self.change_sets.append(changeset)
    ...
    def load_mesh_chemical_nodes(self):
        ...
        changeset = CustomChangeSet(
            ...
            comment,
            query,
            f'{self.file_prefix}{MESH_CHEMICAL_FILE}'
            )
        self.change_sets.append(changeset)
    ...
    def load_mesh_disease_nodes(self):
        ...
        changeset = CustomChangeSet(
            ...
            comment,
            query,
            f'{self.file_prefix}{MESH_DISEASE_FILE}'
            )
        self.change_sets.append(changeset)
