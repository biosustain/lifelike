...
class RegulonChangeLog(ChangeLog):
    ...
    def create_indexes(self):
        queries = []
        queries.append(
            get_create_constraint_query(NODE_REGULONDB, PROP_ID, 'constraint_regulondb_id') + ';'
            )
        queries.append(
    ...
    def load_gene_nodes(self):
        ...
        changeset = CustomChangeSet(
            ...
            comment,
            query,
            f'{self.file_prefix}{REGULON_GENE_FILE}'
            )
        self.change_sets.append(changeset)
    ...
    def load_operon_nodes(self):
        ...
        changeset = CustomChangeSet(
            ...
            comment,
            query,
            f'{self.file_prefix}{REGULON_OPERON_FILE}'
            )
        self.change_sets.append(changeset)
    ...
    def load_gene_product_nodes(self):
        ...
        changeset = CustomChangeSet(
            ...
            comment,
            query,
            f'{self.file_prefix}{REGULON_PRODUCT_FILE}'
            )
        self.change_sets.append(changeset)
    ...
    def load_promoter_nodes(self):
        ...
        query = get_create_update_nodes_query(
            NODE_REGULONDB,
            PROP_ID,
            [PROP_REGULONDB_ID, PROP_NAME, PROP_POS_1, PROP_SIGMA_FACTOR, PROP_SEQUENCE,
             PROP_STRAND],
            [NODE_PROMOTER],
            data_source='RegulonDB'
            )
    ...
    def load_regulon_nodes(self):
        ...
        changeset = CustomChangeSet(
            ...
            comment,
            query,
            f'{self.file_prefix}{REGULON_D_FILE}'
            )
        self.change_sets.append(changeset)
    ...
    def load_terminator_nodes(self):
        ...
        query = get_create_update_nodes_query(
            NODE_REGULONDB,
            PROP_ID,
            [PROP_REGULONDB_ID, PROP_POS_LEFT, PROP_POS_RIGHT, PROP_TERMINATOR_CLASS,
             PROP_SEQUENCE],
            [NODE_TERMINATOR],
            data_source='RegulonDB'
            )
    ...
    def load_promoter_transunit_rels(self):
        ...
        query = get_create_relationships_query(
            NODE_REGULONDB, PROP_ID, 'promoter_id',
    ...
    def load_operon_transunit_rels(self):
        ...
        comment = ''
        query = get_create_relationships_query(
            NODE_REGULONDB, PROP_ID, 'transcription_unit_id',
    ...
    def load_regulates_rels(self):
        ...
        comment = ''
        query = get_create_relationships_query(
            NODE_REGULONDB, PROP_ID, 'regulator_id', NODE_REGULONDB, PROP_ID, 'regulated_id',
    ...
    def load_promoter_function_rels(self):
        ...
        comment = ''
        query = get_create_relationships_query(
            NODE_REGULONDB, PROP_ID, 'regulon_id', NODE_REGULONDB, PROP_ID, 'promoter_id',
