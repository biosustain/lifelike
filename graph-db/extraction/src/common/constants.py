...
DB_BIOCYC = 'BioCyc'
DB_ECOCYC = 'EcoCyc'
DB_ECOCYC_COFACTOR = 'EcoCycCofactor'
...
PROP_AGRICOLA_ID = 'agricola_id'
PROP_AUTHORS = 'authors'
PROP_CREDITS = 'credits'
PROP_DOCUMENTATION = 'documentation'
PROP_DOI_ID = 'doi_id'
PROP_INSTANCE_NAME_TEMPLATE = 'instance_name_template'
PROP_MEDLINE_UID = 'medline_uid'
PROP_MEMBER_SORT_FN = 'member_sort_fn'
PROP_MESH_HEADINGS = 'mesh_headings'
PROP_PATHOLOGIC_NAME_MATCHER_EVIDENCE = 'pathologic_name_matcher_evidence'
PROP_PATHOLOGIC_PWY_EVIDENCE = 'pathologic_pwy_evidence'
PROP_REFERENT_FRAME = 'referent_frame'
PROP_SOURCE = 'source'
PROP_YEAR = 'year'
PROP_TITLE = 'title'
PROP_INCHI = 'inchi'
