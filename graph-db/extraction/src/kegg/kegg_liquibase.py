...
class KeggChangeLog(ChangeLog):
    ...
    def create_indexes(self):
        ...
        queries.append(
            get_create_constraint_query(NODE_SYNONYM, PROP_NAME, 'constraint_synonym_name') + ';'
            )
        queries.append(
    ...
    def load_genome_nodes(self):
        ...
        changeset = CustomChangeSet(
            ...
            comment,
            query,
            f'{self.file_prefix}{GENOME_FILE}'
            )
        self.change_sets.append(changeset)
    ...
    def load_pathway_nodes(self):
        ...
        changeset = CustomChangeSet(
            ...
            comment,
            query,
            f'{self.file_prefix}{PATHWAY_FILE}'
            )
        self.change_sets.append(changeset)
    ...
    def load_gene2ko_rels(self):
        ...
        changeset = CustomChangeSet(
            ...
            comment,
            query,
            f'{self.file_prefix}{GENE2KO_FILE}'
            )
        self.change_sets.append(changeset)
    ...
    def load_ko2pathway_rels(self):
        ...
        changeset = CustomChangeSet(
            ...
            comment,
            query,
            f'{self.file_prefix}{KO2PATHWAY_FILE}'
            )
        self.change_sets.append(changeset)
    ...
    def load_genome2pathway_rels(self):
        ...
        changeset = CustomChangeSet(
            ...
            comment,
            query,
            f'{self.file_prefix}{GENOME2PATHWAY_FILE}'
            )
        self.change_sets.append(changeset)
