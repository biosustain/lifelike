...
**lifelike-after-refactor-08082021.dump (26g)**: dump file for lifelike, which was restored from google lifelike-stg dump file, then
performed the above refactoring steps.

**lifelike-copy-08082021.dump (6.8g)**: lifelike was copied to lifelike-stg using neo4j-admin copy --from-database=lifelike, to-database=lifelike-stg --force
