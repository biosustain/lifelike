...
*****ARANGO_DB_NAME***-after-refactor-08082021.dump (26g)**: dump file for ***ARANGO_DB_NAME***, which was restored from google ***ARANGO_DB_NAME***-stg dump file, then
performed the above refactoring steps.

*****ARANGO_DB_NAME***-copy-08082021.dump (6.8g)**: ***ARANGO_DB_NAME*** was copied to ***ARANGO_DB_NAME***-stg using neo4j-admin copy --from-database=***ARANGO_DB_NAME***, to-database=***ARANGO_DB_NAME***-stg --force
