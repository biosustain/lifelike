...
function grouped(formatterClass) {
  return /** @class */ (function (_super) {
    ...
    Formatter.prototype.sortFailures = function (failures) {
      ...
      return [].concat(
        groupedFailures.off.sort(tslint_1.RuleFailure.compare),
        groupedFailures.warning.sort(tslint_1.RuleFailure.compare),
        groupedFailures.error.sort(tslint_1.RuleFailure.compare)
      );
    };
    return Formatter;
  })(formatterClass);
