...
import { SharedSankeyModule } from 'app/sankey/shared-sankey/shared-sankey.module';
...
import { SankeyManyToManyOverwriteModule } from './sankey-many-to-many-viewer/sankey-viewer-lib.module';
import { SankeyOverwriteModule } from './sankey-viewer/sankey-viewer-lib.module';
...
@NgModule({
  ...
  imports: [
    ...
    SharedSankeyModule,
    SankeyManyToManyOverwriteModule,
    SankeyOverwriteModule
  ],
  exports: [
    SankeyViewComponent
  ],
