import { PRESCALERS } from 'app/sankey/sankey-viewer/components/algorithms/prescalers';
import { LINK_PALETTES } from 'app/sankey/sankey-viewer/components/color-palette';
