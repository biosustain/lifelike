...
@NgModule({
  ...
  providers: [
    ...
    {
      provide: SANKEY_ADVANCED,
      useValue: SankeySingleLaneAdvancedPanelComponent,
    },
    { provide: SANKEY_GRAPH, useValue: SankeySingleLaneComponent },
    {
      provide: SANKEY_DETAILS,
      useValue: SankeySingleLaneDetailsPanelComponent,
    },
  ],
  imports: [
    CommonModule,
