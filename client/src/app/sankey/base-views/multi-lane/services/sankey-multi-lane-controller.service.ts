...
import { merge, omit, transform, cloneDeepWith, clone, max } from 'lodash-es';
...
@Injectable()
// @ts-ignore
export class SankeyMultiLaneControllerService extends SankeyBaseViewControllerService {
  constructor(
