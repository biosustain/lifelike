...
import { Map, UniversalGraphNode } from '../../services/interfaces';
...
export class MapEditorComponent extends MapViewComponent<Map> implements OnInit, OnDestroy {
