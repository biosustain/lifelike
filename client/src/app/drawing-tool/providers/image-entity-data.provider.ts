...
export const FILESYSTEM_IMAGE_TRANSFER_TYPE =
  "vnd.***ARANGO_DB_NAME***.transfer/image-node";
export const FILESYSTEM_IMAGE_HASHID_TYPE = "vnd.***ARANGO_DB_NAME***.transfer/image-hash";

@Injectable()
export class ImageEntityDataProvider
  implements DataTransferDataProvider<ImageTransferData>
{
