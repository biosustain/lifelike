...
export const termsOfServiceAgreeing = createAction('[Auth] Open dialog to Terms Of Service');
...
export const disagreeTermsOfService = createAction('[Auth] Disagree to Terms Of Service');

export const login = createAction('[Auth] Login', props<{ credential: Credential }>());

export const loginSuccess = createAction('[Auth] Login Success', props<{ user: PrivateAppUser }>());
...
export const loginFailureReset = createAction('[Auth] Login Failure Reset');

/** A login redirect carries the original requested url */
export const loginRedirect = createAction('[Auth] Login Redirect', props<{ url: string }>());

export const logout = createAction('[Auth] Logout');

export const oauthLogout = createAction('[Auth] OAuth Logout');

/** Used when an update is performed on a logged in user */
export const refreshUser = createAction('[Auth] Refresh User', props<{ user: AppUser }>());

export const loginReset = createAction('[Auth] Login Reset');

export const logoutSuccess = createAction(LOGOUT_SUCCESS);

export const failedPasswordUpdate = createAction('[Auth] Initial Password Update Failed');

export const successPasswordUpdate = createAction('[Auth] Initial Password Updated Successfully');

export const updatePassword = createAction('[Auth] Changing Initial Password');
