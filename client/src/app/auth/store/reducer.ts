...
const authReducer = createReducer(
  ...
  on(AuthActions.oauthLoginSuccess, (state, { ***ARANGO_DB_NAME***User, oauthUser }) => ({
    ...state,
    loggedIn: true,
    errorMessage: null,
    user: {
  ...
  on(AuthActions.loginRedirect, (state, { url }) => ({
    ...state,
    targetUrl: url,
  })),
  on(AuthActions.logout, () => initialState),
  on(AuthActions.oauthLogout, () => initialState),
  on(AuthActions.refreshUser, (state, { user }) => ({
    ...state,
    user,
  })),
  on(AuthActions.loginReset, () => initialState),
  on(AuthActions.loginFailureReset, (state) => ({
    ...state,
    errorMessage: null,
  })),
  on(AuthActions.updateUserSuccess, (state, { userUpdateData }) => ({
    ...state,
    user: {
  ...
  on(AuthActions.updateOAuthUserSuccess, (state, { userUpdateData }) => ({
    ...state,
    user: {
