...
export interface DuplicateVisNode<Data = DefaultNodeData>
  extends VisNode<Data> {
  id: any;
  duplicateOf: number;
}

/** VisJS Edge Representations for Client */
export interface VisEdge<Data = Record<string, any>>
  extends GraphRelationship<Data> {
  arrows?: string;
  color: any;
}
...
export interface DuplicateVisEdge<Data = Record<string, any>>
  extends VisEdge<Data> {
  id: any;
...
export interface FTSReferenceRecord<Data = DefaultNodeData>
  extends FTSQueryRecord<Data> {
