...
export function toRequest<Arguments extends Array<any>, Result extends object>(request: (...args: Arguments) => Observable<Result>) {
  return (arguments$: Observable<Arguments>) => arguments$.pipe(
    map((arg) => {
