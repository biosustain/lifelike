import { DatabaseLink, EntityType } from '../schemas/annotation-types';
...
export const ENTITY_TYPES = [
  ...
  new EntityType(
    ...
    [
      {
        name: DatabaseType.BIOCYC,
        url: 'https://biocyc.org/compound?orgid=META&id=',
      } as DatabaseLink,
    ]
  ),
  new EntityType(
  ...
  new EntityType(
    ...
    [
      ...
      {
        name: DatabaseType.BIOCYC,
        url: 'https://biocyc.org/gene?orgid=PPUT160488&id=',
      } as DatabaseLink,
    ]
  ),
  new EntityType(
  ...
  new EntityType(
    ...
    [
      {
        name: DatabaseType.NCBI_TAXONOMY,
