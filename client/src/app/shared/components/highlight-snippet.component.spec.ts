...
describe("HighlightSnippetComponent", () => {
  ...
  it("should wrap key terms with html spans", () => {
    const keyTermSpans = document
      .getElementById("highlighted-snippets-container")
  ...
  it("should style key term spans with input colors", () => {
    ...
    expect(keyTerm1Span.style.backgroundColor).toEqual(
      "rgba(205, 93, 103, 0.3)"
    );
    expect(keyTerm2Span.style.backgroundColor).toEqual(
      "rgba(143, 166, 203, 0.3)"
    );
  });
});
