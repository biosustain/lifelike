...
export class SearchableTreeComponent implements OnChanges {
  ...
  @ContentChild("treeNode", { static: true })
  treeNodeTemplateRef: TemplateRef<any>;
  @ContentChild("treeNestedNode", { static: true })
  treeNestedNodeTemplateRef: TemplateRef<any>;
  treeControl = new NestedTreeControl<SearchableTreeNode>(
    ({ children }) => children
  );
