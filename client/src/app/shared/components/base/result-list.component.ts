...
export abstract class ResultListComponent<
  O,
  R,
  RL extends ResultList<R> = ResultList<R>
> implements OnInit, OnDestroy
{
  public loadTask: BackgroundTask<O, RL> = new BackgroundTask((params) =>
  ...
  abstract serializeParams(
    params: O,
    restartPagination: boolean
  ): Partial<Record<keyof O, string>>;
}
