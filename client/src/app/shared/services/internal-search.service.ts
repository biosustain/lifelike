...
export class InternalSearchService {
  ...
  getVisualizerLink(query, params = {}) {
    return this.router.createUrlTree(
      ...this.getVisualizerArguments(query, params)
    );
  }

  getFileContentLink(query, params = {}) {
    return this.router.createUrlTree(
      ...this.getFileContentsArguments(query, params)
    );
  }

  getFileContentsArguments(
    query,
    params = {}
  ): Parameters<WorkspaceManager["navigate"]> {
    return [
      ["/search/content"],
      {
