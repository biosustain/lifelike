 ...
 * the ***ARANGO_USERNAME*** meta-reducer. To add more meta-reducers, provide an array of meta-reducers
 * that will be composed to form the ***ARANGO_USERNAME*** meta-reducer.
 */
