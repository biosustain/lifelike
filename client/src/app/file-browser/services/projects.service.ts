...
export class ProjectsService {
            ...
            map((data) => {
              const projectList = new ProjectList(
                data.results.map((itemData) =>
                  new ProjectImpl().update(itemData)
                )
              );
  ...
  search(options: ProjectSearchRequest): Observable<ProjectList> {
    return this.http
      .post<ResultList<ProjectData>>(`/api/projects/search`, options)
      .pipe(
        map((data) => {
          const projectList = new ProjectList(
  ...
  getCollaborators(
    ...
    return this.http
      .get<ResultList<CollaboratorData>>(
  ...
  saveCollaborators(
    ...
    return this.http
      .post<ResultList<CollaboratorData>>(
        `/api/projects/projects/${hashId}/collaborators`,
        request
      )
      .pipe(
