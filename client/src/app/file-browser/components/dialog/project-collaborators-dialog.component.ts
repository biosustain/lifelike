...
export class ProjectCollaboratorsDialogComponent extends CommonFormDialogComponent<void> {
  ...
  collaborators$: Observable<ModelList<Collaborator>> = of(
    new ModelList<Collaborator>()
  );
  ...
  refresh() {
    this.collaborators$ = this.projectsService.getCollaborators(
      this.project.hashId,
      {
  ...
  private saveCollaborators(
    ...
    return this.projectsService
      .saveCollaborators(this.project.hashId, request)
      .pipe(
        tap((collaborators) => {
