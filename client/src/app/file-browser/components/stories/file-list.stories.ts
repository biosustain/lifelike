...
import {EnrichmentVisualisationCreateDialogComponent} from "../../../enrichment-tables/components/visualisation/dialog/enrichment-visualisation-create-dialog.component";
