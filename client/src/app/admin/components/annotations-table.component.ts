...
export class AnnotationTableComponent implements OnInit, OnDestroy {
  ...
  readonly loadTask: BackgroundTask<PaginatedRequestOptions, ResultList<GlobalAnnotationListItem>> =
  ...
  openNewWindow(fileHashId: string) {
    this.filesystemService
      .get(fileHashId)
      .pipe()
      .subscribe((fileObject) => this.filesystemObjectActions.openNewWindow(fileObject));
  }
