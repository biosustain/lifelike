...
describe("ContextMenuComponent", () => {
  ...
  beforeEach(() => {
    ...
    contextMenuControlService = TestBed.get<ContextMenuControlService>(
  ...
  it("should show 'Settings' option even if no nodes or edges are selected", async () => {
    ...
    await fixture.whenStable().then(() => {
      const settingsGroupElement = document.getElementById(
        "settings-group-" + component.tooltipId
      );
  ...
  it("should show 'Remove Selected Node(s)' if at least one node is selected", async () => {
    ...
    await fixture.whenStable().then(() => {
      const nodeSelectionGroupElement = document.getElementById(
        "node-selection-group-" + component.tooltipId
      );
  ...
  it("should show 'Remove Selected Edge(s)' if at least one node is selected", async () => {
    ...
    await fixture.whenStable().then(() => {
      const edgeSelectionGroupElement = document.getElementById(
        "edge-selection-group-" + component.tooltipId
      );
  ...
  it("should show 'Group by Relationship' option if a single node with at least one connecting edge is selected", async () => {
    ...
    await fixture.whenStable().then(() => {
      const groupByRelElement = document.getElementById(
        "group-by-rel-menu-item-" + component.tooltipId
      );
  ...
  it("should show grouping submenu after a delay", async () => {
    ...
    const delayGroupByRelSpy = spyOn(
      contextMenuControlService,
      "delayGroupByRel"
    ).and.callThrough();
    component.selectedNodeIds = mockSelectedNodeIds;
    ...
    await fixture.whenStable().then(async () => {
      ...
      fixture.detectChanges();
      await fixture.whenStable().then(() => {
        const groupByRelSubmenuElement = document.getElementById(
          "single-node-selection-group-1-submenu-" + component.tooltipId
        );
  ...
  it("should interrupt showing the group by relationship submenu if the user hovers away", async () => {
    const mouseLeaveNodeRowSpy = spyOn(
      component,
      "mouseLeaveNodeRow"
    ).and.callThrough();
    const interruptGroupByRelSpy = spyOn(
      contextMenuControlService,
      "interruptGroupByRel"
    );
    component.selectedNodeIds = mockSelectedNodeIds;
  ...
  it("should show 'Pull out node from cluster' option if a cluster is selected", async () => {
    ...
    await fixture.whenStable().then(() => {
      const pullOutNodeElement = document.getElementById(
        "pull-out-node-from-cluster-menu-item-" + component.tooltipId
      );
  ...
  it("should show pull out node submenu after a delay", async () => {
    ...
    const delayPullOutNodeSpy = spyOn(
      contextMenuControlService,
      "delayPullOutNode"
    ).and.callThrough();
    component.selectedClusterNodeData = mockSelectedClusterNodeData;
    ...
    await fixture.whenStable().then(async () => {
      ...
      fixture.detectChanges();
      await fixture.whenStable().then(() => {
        const pullOutNodeSubmenuElement = document.getElementById(
          "pull-out-node-from-cluster-submenu-" + component.tooltipId
        );
  ...
  it("should interrupt showing the pull out node submenu if the user hovers away", async () => {
    ...
    const interruptPullOutNodeSpy = spyOn(
      contextMenuControlService,
  ...
  it("should request neighbor selection if 'Select Neighbors' is clicked", async () => {
    const requestNeighborSelectionSpy = spyOn(
      component,
    ...
    await fixture.whenStable().then(() => {
      const selectNeighborsElement = document.getElementById(
        "select-neighbors-menu-item-" + component.tooltipId
      );
  ...
  it("should request node removal if 'Remove Selected Node(s)' is clicked", async () => {
    ...
    await fixture.whenStable().then(() => {
      const removeSelectedNodesElement = document.getElementById(
        "remove-selected-nodes-menu-item-" + component.tooltipId
      );
  ...
  it("should request edge removal if 'Remove Selected Edge(s)' is clicked", async () => {
    ...
    await fixture.whenStable().then(() => {
      const removeSelectedEdgesElement = document.getElementById(
        "remove-selected-edges-menu-item-" + component.tooltipId
      );
  ...
  it("should begin tooltip fadeout when hideTooltip$ observable emits true", () => {
    const beginContextMenuFadeSpy = spyOn(
      component,
