  ...
  implements AfterViewInit, OnDestroy, OnChanges
{
  ...
  @Output() groupNeighborsWithRelationship: EventEmitter<GroupRequest> =
    new EventEmitter();
  ...
  subMenus: string[] = [
    "single-node-selection-group-1-submenu",
    "pull-out-node-from-cluster-submenu",
  ];
  ...
  constructor(private contextMenuControlService: ContextMenuControlService) {
    super();
    ...
    this.hideContextMenuSubscription =
      this.contextMenuControlService.hideTooltip$.subscribe(
        (hideContextMenu) => {
          if (hideContextMenu) {
    ...
    this.updatePopperSubscription =
      this.contextMenuControlService.updatePopper$.subscribe(
  ...
  showGroupByRelSubMenu() {
    ...
    this.contextMenuControlService.showGroupByRelResult$
      .pipe(
        first(),
  ...
  showPullOutNodeSubMenu() {
    ...
    this.contextMenuControlService.showPullOutNodeResult$
      .pipe(
        first(),
