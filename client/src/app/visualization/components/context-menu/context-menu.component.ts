  ...
  implements AfterViewInit, OnDestroy, OnChanges
{
  ...
  constructor(private contextMenuControlService: ContextMenuControlService) {
    ...
    this.hideContextMenuSubscription = this.contextMenuControlService.hideTooltip$.subscribe(
      (hideContextMenu) => {
        if (hideContextMenu) {
    ...
    this.updatePopperSubscription = this.contextMenuControlService.updatePopper$.subscribe(
