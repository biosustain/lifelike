  ...
  implements OnDestroy
{
  ...
  constructor() {
    ...
    this.delayGroupByRelSourceSubscription =
      this.delayGroupByRelSource.subscribe(() => {
        const example = race(
    ...
    this.delayPullOutNodeSourceSubscription =
      this.delayPullOutNodeSource.subscribe(() => {
        const example = race(
