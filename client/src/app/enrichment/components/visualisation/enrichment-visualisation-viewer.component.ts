import { Component, Input, ViewChild, EventEmitter, OnDestroy, OnInit, Output } from '@angular/core';
...
import {EnrichmentTableService, NCBIWrapper} from '../../services/enrichment-table.service';
