 ...
 */
export const createNode = <N extends Partial<UniversalGraphNodeTemplate>>(
  partialNode: N
) =>
  merge(NODE_DEFAULTS_FACTORY(), cloneDeep(partialNode), {
    hash: uuidv4(),
...
export const createImageNode = <
  IN extends Partial<UniversalGraphImageNodeTemplate>
>(
  partialImage: IN
) =>
  createNode(
    merge(IMAGE_DEFAULTS_FACTORY(), partialImage, { image_id: makeid() })
  ) as ReturnType<typeof NODE_DEFAULTS_FACTORY> &
