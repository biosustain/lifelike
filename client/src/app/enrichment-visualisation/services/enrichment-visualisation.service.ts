...
import {
  ...
  mergeStatuses,
  MultiPipeStatus,
} from 'app/shared/modules/utils/pipes/add-status.pipe';
import {
  BaseEnrichmentDocument,
  EnrichmentDocument,
} from 'app/enrichment-table/models/enrichment-document';
import { EnrichmentService } from 'app/enrichment-table/services/enrichment.service';
