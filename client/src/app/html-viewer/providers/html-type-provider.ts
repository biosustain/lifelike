...
export const BIOC_MIMETYPE = 'vnd.***ARANGO_DB_NAME***.document/html';
export const BIOC_SHORTHAND = 'HTML';

@Injectable()
export class HtmlTypeProvider extends AbstractObjectTypeProvider {
